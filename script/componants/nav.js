...
<div><h1 onclick="kfc"><a href="index1.html">KFC</a></h1></div>
    <div><h3>Menu</h3></div>
    <div><h3>Deals</h3></div>
</div>
...
<div id="nav2">
    ...
    <div><h4>0</h4></div>
    <div><img src="https://images.ctfassets.net/wtodlh47qxpt/6qtBVFuno7pdwOQ9RIvYm9/d13e9b7242980972cf49beddde2cc295/bucket_cart_icon.svg" alt=""></div>
</div>
    </div>
    <div id="nav_two">
